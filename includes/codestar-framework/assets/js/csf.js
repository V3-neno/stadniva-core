...
;(function( $, window, document, undefined ) {
  ...
  $.fn.csf_field_repeater = function() {
    return this.each( function() {
      ...
      // clone on dynamically created elements
      // $(document).on('click', '.csf-repeater-clone', event_clone);

      // $(document).children('.csf-repeater-item').children('.csf-repeater-helper').on('click', '.csf-repeater-clone', event_clone);
      // $(document).children('.csf-repeater-hidden').children('.csf-repeater-helper').on('click', '.csf-repeater-clone', event_clone);
      ...
      // $(document).children('.csf-repeater-item').children('.csf-repeater-helper').on('click', '.csf-repeater-remove', event_remove);
      // $(document).children('.csf-repeater-hidden').children('.csf-repeater-helper').on('click', '.csf-repeater-remove', event_remove);

      // remove on dynamically created elements
      // $(document).on('click', '.csf-repeater-remove', event_remove);
